let timelineElements = [
    {
        id:1,
        title: "Techniacl Solutions Developer",
        location:"Optum",
        description: [
    ...
    {
        id:2,
        title: "Smartsheet & SharePoint Administraton",
        location:"Optum",
        description: [
    ...
    
    {
        ...
        description: [
        "Managed the supply chain for clinical locations, ensuring optimal inventory levels across assigned rooms and warehouse sites.",
        "Troubleshoot inventory errors and worked closely with clinical staff to assign new products and improve stock management processes."
        ],
        date: "March 2023 - Presnet"
    }
]
